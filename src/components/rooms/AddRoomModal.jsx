...
export default function AddRoomModal({
  ...
  const floorOptions = useMemo(() => {
    const floorsCount = Number(property?.floors_count || 0);
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="relative">
                    <select
                      value={property?.id || ""}
                      disabled
                      className="w-full pl-3.5 pr-10 py-2.5 sm:py-2 bg-slate-50 border border-slate-200 rounded-lg text-[13px] text-slate-800 focus:bg-white focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand appearance-none cursor-not-allowed"
                    >
